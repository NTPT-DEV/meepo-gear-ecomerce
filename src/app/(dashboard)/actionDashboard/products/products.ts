...
import { TImageUrlTypeArray, TypeProductSchema } from "schemas/productFormSchema";


//// Create a new product
export const createProduct = async (payload: TypeProductSchema) => {
  try {
    const product = await prisma.product.create({
      data: {
        ...
        images: {
          create: (payload.productImage as TImageUrlTypeArray).map((item) => ({
