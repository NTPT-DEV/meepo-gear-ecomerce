...
import ProductList from "../D-Components/ProductList";
  ...
  return (
    <div className="flex justify-between">
      ...
      <div className="right-container flex flex-col w-full h-screen">
        ...
        <div className="bg-black flex w-full h-auto justify-between py-5 px-15 gap-x-15 items-center rounded-full">
          <div className="flex w-full gap-10 items-center">
            <div className="text-white text-sm">BRAND : NVIDIA</div>
            <div className="text-white text-sm">SORT BY : Price</div>
          </div>
          <div className="bg-lime-400 w-10 h-10 flex items-center justify-center rounded-full hover:w-60 hover:justify-start transition-all duration-500 hover:bg-white  hover:pl-3">
