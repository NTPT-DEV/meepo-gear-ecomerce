      ...
      {isClick && (
        <AnimatePresence>
          <motion.div
            ...
            className="flex justify-center items-center fixed inset-0 z-10 bg-black/50 backdrop-blur-xs shadow-2xl"
          >
            <motion.div
              ...
              className="bg-zinc-900/80 w-[70%]  overflow-y-hidden rounded-2xl px-6 pt-4 pb-7 flex flex-col items-center relative shadow-md"
            >
              {/* Search Bar */}
              <motion.div
                initial={{ opacity: 0, y: -5 }}
                ...
                className="flex justify-center items-center w-full gap-2 p-3 mt-5 z-20"
              >
              ...
              <div className="flex flex-col items-center w-full gap-y-[0.01rem] overflow-y-auto max-h-[370px] my-2 no-scrollbar">
                {result.length > 0 &&
                  result.map((item: Product, index) => (
                    ...
                    >
                      <div
                        className="flex justify-center items-center w-full min-h-20 h-auto p-3
