  ...
  return (
    <div className="bottom-0 left-0 right-0 mt-4">
      <div className="footer bg-black w-full h-[100px] rounded-t-[150px] relative ">
        <div
          className="flex justify-between items-center px-10 rounded-[20px] rounded-t-[50px] max-w-[90%] 
        ...
        >
          <Link href="/">
            <LogoMeepoGearV2 className="text-black w-auto h-4 cursor-pointer hover:scale-105 transition-all duration-300" />
          </Link>
          <p className="text-center text-[12px] text-nowrap max-[520px]:text-wrap">
            © 2023 Meepo Gear All Rights. | Terms & Conditions | Privacy Policy
          </p>
